...
$check_payment =  " SELECT * FROM payment WHERE payment_status = 'paid' ";
$results =  mysqli_query($conn, $check_payment);
 if(mysqli_num_rows($results) > 0) {
     while($rows = mysqli_fetch_assoc($results)){
         $trans = $rows['request_id'];

         $select_request =  " SELECT * FROM ro_request WHERE request_id = '$trans' ";
...
if(isset($_POST['approve'])){
    ...
    $update_query = " UPDATE ro_request SET  request_status = 'accepted', approved_by = '$Cname', approved_date = '$date'  WHERE request_id = '$requestId' ";
...
if(isset($_POST['disapprove'])){
    ...
    $update_query = " UPDATE ro_request SET request_status = 'pending', approved_by = 'NO' , approved_date = '0000-00-00 00:00:00'  WHERE request_id = '$requestId' ";
