        ...
        <?php
          ...
          <div class="card bg-light p-4 mt-2">
                    ...
                    <div class="col-sm-12">                       
                        <nav class="navbar responsive">
                            <ul class="nav">
                                ...
                                <li class="nav-item progress progress"></li>
                                <li class="nav-item  round bg-info text-center"><i class="fas fa-check"></i></li>
                            </ul>
                        </nav>
                    </div>
           ...
           <div class="form-group">
               <h4 class="display-5 text-success mb-4 text-center">Step Two Plot Details</h4>
               <form action="" method="POST" class="needs-validation mt-4">
                   ...
                   <button type="submit" name="next" class="btn btn-primary mr-4"><i class="fas fa-arrow-circle-right"></i> Submit </button>
                   
                   <a href="nationality.php" class="btn btn-info ml-4">  <i class="fas fa-arrow-circle-left"></i> Back</a>
                </form>
               </div>
           </div>
