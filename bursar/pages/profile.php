        ...
        <div class="row">
          ...
          ?>
                   ...
                   ?>
                    <form action="" method="post" class="needs-validation mt-4">
                        <div class="row">
                            ...
                            <div class="col">                               
                                <div class="col">
                                    ...
                                    <input type="password" id="password" name="password"  placeholder="Enter your password" class="form-control" value="<?= $rows['password'] ?>" required>
                                    <div class="invalid-feedback">Please fill out this field.</div>
                        ...
                        <!-- <div class="row">
                         ...
                         <a href="plot_lists.php" class="btn btn-info mb-4 ml-4">Back</a>
                    </form>
                 <?php
                    }
                }
                ...
                if(isset($_POST['update'])){
                   ...
                   $update_query =  " UPDATE users SET fname='$fname', surname = '$mname', lname='$lname', gender='$gender', email = '$email', phone = '$phone', residence = '$residence', password = '$password' WHERE user_id = '$user_id' " ;
