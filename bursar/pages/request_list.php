    ...
    $user =  $_SESSION['username'];
     ...
     if(mysqli_num_rows($user_result) > 0){
         while($row = mysqli_fetch_assoc($user_result)){
             ...
             $Bname = $row['fname']." ". $row['surname']. " " . $row['lname'];
...
if(isset($_POST['approve'])){
    ...
    $update_query = " UPDATE ro_request SET payment_status = 'paid', checked_by = '$Bname'  WHERE request_id = '$requestId' ";
...
if(isset($_POST['disapprove'])){
    ...
    $update_query = " UPDATE ro_request SET payment_status = 'pending', checked_by = 'NO'  WHERE request_id = '$requestId' ";
