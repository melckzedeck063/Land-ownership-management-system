          ...
          ?>
           ...
           <div class="form-group">
               ...
               <form action="" method="POST" class="needs-validation mt-3">
                   ...
                   <div class="row">
                       <div class="col">
                           <label for="agree">I agree to the terms and and condition</label>
                           <input type="text" name="agree" id="agree" placeholder="Confirm that you agree" class="form-control" required>
                           <div class="invalid-feedback">Please fill out this field</div>
                           <hr class="mt-3">
                       </div>
                       <div class="col">
