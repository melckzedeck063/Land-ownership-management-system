    ...
    <div>
        <div class="row">
          ...
          <div class="card p-4 bg-light">
                    <h4 class="display-4 text-center text-success">Registration Form</h4>
                    <form action="" method="post" class="needs-validation mt-4">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="hidden" name="nation" value="Tanzania" class="form-control">
                        ...
                        <div class="row">
                         ...
                         <a href="users_list.php" class="btn btn-info mb-4 ml-4"> <i class="fas fa-arrow-circle-left"></i> Back</a>
                    </form>
                    </div>
                    <div class="mt-4 mb-4">
...
if(!empty($fname) && !empty($mname) && !empty($lname) && !empty($gender) && !empty($email) && !empty($phone) && !empty($residence) && !empty($password) && !empty($role) && !empty($age) && !empty($nationality) ){
        ...
        if(isset($_POST['save'])){
            ...
            if($results == TRUE ){
                $_SESSION['success'] = "New member succesfully added";
